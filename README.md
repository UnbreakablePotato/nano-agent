...
## Key Features
**Stateful Reasoning** Utilizes Gemini's long-context window to maintain multi turn logic and goal tracking.
**Modular Tool Use** User interface for adding custom skills.
